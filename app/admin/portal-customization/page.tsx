        ...
        <div>
          ...
          {selectedCorporate && <div style={{ backgroundColor: 'white', borderRadius: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.04)', border: `1px solid ${colors.gray[200]}`, overflow: 'hidden' }}>
            ...
            <div style={{ padding: '24px', maxHeight: '600px', overflowY: 'auto' }}>
              ...
              {activeTab === 'components' && <div><p style={{ fontSize: '13px', color: colors.gray[500], marginBottom: '20px' }}>Toggle which sections appear on the employee portal</p><h4 style={{ fontSize: '14px', fontWeight: '600', marginBottom: '16px', color: colors.gray[700] }}>🔐 Login Page Settings</h4><Toggle label="Consent Checkbox" value={customizations.show_consent_checkbox !== false} onChange={(v: boolean) => updateCustomization('show_consent_checkbox', v)} description="Require users to accept terms before login" /><Toggle label="Privacy Policy Link" value={customizations.show_privacy_link !== false} onChange={(v: boolean) => updateCustomization('show_privacy_link', v)} description="Show privacy policy link on login" /><Toggle label="Terms & Conditions Link" value={customizations.show_terms_link !== false} onChange={(v: boolean) => updateCustomization('show_terms_link', v)} description="Show terms link on login" /><Toggle label="Disclaimer Link" value={customizations.show_disclaimer_link !== false} onChange={(v: boolean) => updateCustomization('show_disclaimer_link', v)} description="Show disclaimer link on login" /><Toggle label="Remember Me Option" value={customizations.show_remember_me !== false} onChange={(v: boolean) => updateCustomization('show_remember_me', v)} description="Allow users to stay logged in" /><Toggle label="Forgot Password Link" value={customizations.show_forgot_password !== false} onChange={(v: boolean) => updateCustomization('show_forgot_password', v)} description="Show forgot password option" /><Toggle label="Login Method Selector" value={customizations.show_login_method_selector !== false} onChange={(v: boolean) => updateCustomization('show_login_method_selector', v)} description="Allow email, mobile, employee ID login" /><Toggle label="OTP Login" value={customizations.enable_otp_login !== false} onChange={(v: boolean) => updateCustomization('enable_otp_login', v)} description="Enable one-time password login" /><h4 style={{ fontSize: '14px', fontWeight: '600', marginTop: '24px', marginBottom: '16px', color: colors.gray[700] }}>📱 Dashboard Sections</h4><Toggle label="Header" value={customizations.show_header !== false} onChange={(v: boolean) => updateCustomization('show_header', v)} description="Navigation bar with logo and menu" /><Toggle label="Hero Section" value={customizations.show_hero_section !== false} onChange={(v: boolean) => updateCustomization('show_hero_section', v)} description="Welcome banner with headline and CTA" /><Toggle label="Benefits Overview" value={customizations.show_benefits_section !== false} onChange={(v: boolean) => updateCustomization('show_benefits_section', v)} description="Summary of available benefits" /><Toggle label="Features Grid" value={customizations.show_features_section !== false} onChange={(v: boolean) => updateCustomization('show_features_section', v)} description="Feature cards with icons" /><Toggle label="FAQ Section" value={customizations.show_faq_section !== false} onChange={(v: boolean) => updateCustomization('show_faq_section', v)} description="Frequently asked questions" /><Toggle label="Contact Information" value={customizations.show_contact_section !== false} onChange={(v: boolean) => updateCustomization('show_contact_section', v)} description="HR contact details" /><Toggle label="Footer" value={customizations.show_footer !== false} onChange={(v: boolean) => updateCustomization('show_footer', v)} description="Copyright and links" /></div>}
