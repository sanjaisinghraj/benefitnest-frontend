  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        title={
          previewType === "login" ? "Login Page Preview" : "Main Portal Preview"
        }
        icon="🖥️"
        size="xl"
      >
      ...
      <Modal
        ...
        onClose={() => !aiSearching && setShowAiConfirmModal(false)}
        ...
        <div style={{ padding: "10px 0" }}>
          {aiSearching ? (
            <div style={{ textAlign: "center", padding: "40px 20px" }}>
              ...
              >
                Looking for "{selectedCorporate?.corporate_legal_name}" online
              </p>
              <div
                style={{
                  display: "flex",
                  ...
                  <div>
                    <h4
                      style={{
                        fontSize: "16px",
                        fontWeight: "700",
                        color: aiDiscoveryResults.found ? "#065f46" : "#92400e",
                        margin: 0,
                      }}
                    >
                    ...
                    <p
                      style={{
                        fontSize: "13px",
                        color: aiDiscoveryResults.found ? "#047857" : "#a16207",
                        margin: "4px 0 0 0",
                      }}
                    >
                      {aiDiscoveryResults.found
                  ...
                  >
                    {aiDiscoveryResults.companyInfo.logo && (
                      ...
                      >
                        ...
                        <img
                          src={aiDiscoveryResults.companyInfo.logo}
                          alt="Logo"
                          ...
                          >
                            <div
                              style={{
                                ...
                                height: "100%",
                                backgroundColor:
                                  aiDiscoveryResults.confidenceScore >= 70
                                    ? "#10b981"
                                    : aiDiscoveryResults.confidenceScore >= 50
                                      ? "#f59e0b"
                                      : "#ef4444",
                                borderRadius: "3px",
                              }}
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: "6px",
                          backgroundColor:
                            aiDiscoveryResults.suggestedSettings.primary_color,
                        }}
                      />
                      <span
                        style={{ fontSize: "12px", color: colors.gray[600] }}
                      >
                        Primary
                      </span>
                    </div>
                    ...
                    <div style={{ fontSize: "12px", color: colors.gray[600] }}>
                      📝{" "}
                      {aiDiscoveryResults.suggestedSettings.heading_font_family}
                    </div>
                    <div style={{ fontSize: "12px", color: colors.gray[600] }}>
                      🏷️ {aiDiscoveryResults.suggestedSettings.theme} theme
                    </div>
                  </div>
                </div>
              )}
      ...
      >
        <div style={{ padding: "20px 0" }}>
          <div style={{ textAlign: "center", marginBottom: "24px" }}>
            ...
            >
              {aiLoading ? "Applying Settings..." : "Settings Applied!"}
            </h3>
            <p style={{ fontSize: "13px", color: colors.gray[500] }}>
              {aiLoading
                ? "Configuring your portal branding"
                : "Brand settings have been applied"}
            </p>
          </div>
          <div
            style={{
                ...
                style={{
                  color: log.startsWith("✅")
                    ...
                    : log.startsWith("❌")
                      ...
                      : "#9ca3af",
                  marginBottom: "8px",
                  opacity: i === aiLogs.length - 1 ? 1 : 0.7,
                }}
              >
                {log}
              </div>
            ...
            {loadingTesters ? (
              ...
              >
                ...
                <div style={{ fontSize: "12px" }}>
                  Add your first test user above to start testing the portal
                </div>
              </div>
            ) : (
              <div
                ...
                {testers.map((tester) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {tester.display_name?.charAt(0).toUpperCase() ||
