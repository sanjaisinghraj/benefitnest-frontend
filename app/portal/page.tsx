...
function PortalLoginContent() {
    ...
    const [customizations, setCustomizations] = useState<PortalCustomizations | null>(null);
    ...
    // =====================================================
    const primaryColor = customizations?.primary_color || tenantInfo?.branding_config?.primary_color || '#2563eb';
    const secondaryColor = customizations?.secondary_color || tenantInfo?.branding_config?.secondary_color || '#10b981';
    ...
    const logoUrl = customizations?.logo_url || tenantInfo?.branding_config?.logo_url;
    const logoWidth = customizations?.logo_width || 150;
    const logoHeight = customizations?.logo_height || 80;
    
    const companyName = customizations?.portal_title || tenantInfo?.corporate_legal_name || 'Employee Portal';
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{ color: textColor, margin: 0, opacity: 0.7 }}>Loading portal...</p>
                </div>
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    <h1 style={{ fontSize: '24px', fontWeight: headingWeight, color: textColor, marginBottom: '8px', fontFamily: headingFont }}>
                        Portal Not Found
                    </h1>
                    <p style={{ color: textColor, opacity: 0.7, marginBottom: '24px' }}>{error}</p>
                    <a href="https://benefitnest.space" style={{
            ...
            <div style={{
                ...
                <div style={{ width: '100%', maxWidth: '420px' }}>
                    ...
                    <div className="show-mobile" style={{ textAlign: 'center', marginBottom: '32px' }}>
                        {logoUrl ? (
                            <img src={logoUrl} alt={companyName} style={{ height: '48px', marginBottom: '16px', objectFit: 'contain' }} />
                        ) : (
                            <div style={{ fontSize: '48px', marginBottom: '8px' }}>🏢</div>
                        )}
                        <h1 style={{ fontSize: '20px', fontWeight: headingWeight, color: textColor, margin: 0, fontFamily: headingFont }}>
                            {companyName}
                        </h1>
                    </div>
                    ...
                    <div style={{
                        ...
                        <p style={{ color: textColor, opacity: 0.7, textAlign: 'center', marginBottom: '32px' }}>
                        ...
                        <div style={{ textAlign: 'center', marginTop: '24px' }}>
                            <a href="#" style={{ color: primaryColor, fontSize: '14px', textDecoration: 'none', fontWeight: '500' }}>
                                Forgot Password?
                            </a>
                        </div>
                    </div>

                    <div style={{ textAlign: 'center', marginTop: '32px', color: textColor, opacity: 0.5, fontSize: '13px' }}>
                        <p>Powered by <strong style={{ opacity: 0.8 }}>BenefitNest</strong></p>
                        <p style={{ marginTop: '8px' }}>
                            <a href="#" style={{ color: textColor, opacity: 0.7, textDecoration: 'none' }}>Privacy Policy</a>
                            {' • '}
                            <a href="#" style={{ color: textColor, opacity: 0.7, textDecoration: 'none' }}>Terms of Service</a>
                        </p>
                    </div>
                </div>
            </div>
