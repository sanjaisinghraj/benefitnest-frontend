...
const wellnessModules = [
  {
    ...
    description:
      "Complete a comprehensive health questionnaire to understand your health profile and get personalized insights.",
    icon: "🏥",
  ...
  },
  {
    ...
    description:
      "Track your mood, assess stress levels, and access mental wellness resources.",
    icon: "🧠",
  ...
  },
  {
    ...
    description:
      "Chat with your personal AI wellness coach for guidance on health, fitness, and lifestyle.",
    icon: "🤖",
  ...
  },
  {
    ...
    description:
      "View and manage your personalized wellness plan with daily tasks and milestones.",
    icon: "📋",
  ...
  },
  {
    ...
    name: "Knowledge Hub",
    description:
      "Explore curated articles, tips, and resources on nutrition, exercise, sleep, and more.",
    icon: "📚",
  ...
  },
  {
    ...
    description:
      "Stay on top of your health with reminders for checkups, vaccinations, and screenings.",
    icon: "🩺",
  ...
  },
  {
    ...
    description:
      "Learn about budgeting, emergency funds, insurance literacy, and financial planning.",
    icon: "💰",
  ...
  },
  {
    ...
    name: "Habit Tracker",
    description:
      "Build healthy habits with daily tracking, streaks, and fun challenges.",
    icon: "✅",
  ...
  },
  {
    ...
    description:
      "Reflect on your day with a private, encrypted journal. Track moods and thoughts.",
    icon: "📔",
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
      {stats.map((stat, i) => (
        ...
        >
          ...
          <div
            className={`text-2xl font-bold mt-1 ${stat.color || "text-gray-800"}`}
          >
            {stat.value}
          </div>
        </div>
...
const DailyTip = () => {
  const tips = [
    {
      icon: "💧",
      text: "Stay hydrated! Aim to drink at least 8 glasses of water today.",
    },
    { icon: "🚶", text: "Try to take a short walk every hour to stay active." },
    {
      icon: "🍎",
      text: "Add an extra serving of vegetables to your lunch today.",
    },
    {
      icon: "😴",
      text: "Wind down 30 minutes before bed for better sleep quality.",
    },
    {
      icon: "🧘",
      ...
      <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl">
        ...
        <div className="flex items-start gap-3 mb-6">
          ...
          <label htmlFor="consent" className="text-sm text-gray-700">
            I have read and agree to the wellness program terms and conditions.
...
export default function WellnessPortalPage() {
  ...
  const fetchWellnessData = async () => {
    try {
      ...
      const consentRes = await fetch(
        `${API_URL}/api/wellness/employee/consent`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
      ...
      const themeRes = await fetch(
        `${API_URL}/api/portal/branding/${tenantId}`,
      );
      if (themeRes.ok) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600">
            The wellness portal is not currently available for your
            organization. Please check back later or contact your HR department.
          </p>
          <button
            onClick={() => router.back()}
  ...
  const showConsentModal =
    requireConsent && (!consent || !consent.consent_given);
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Your personal health and wellbeing hub
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="mb-8">
          ...
          {enabledModules.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-xl border-2 border-dashed border-gray-300">
              ...
              <p className="text-gray-600">
                No wellness modules are currently enabled.
              </p>
            </div>
          ) : (
              ...
              {enabledModules.map((module) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${module.color} flex items-center justify-center text-2xl shadow-lg group-hover:scale-110 transition-transform`}
                    >
                      {module.icon}
                    </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto p-6 shadow-2xl">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                This module will be fully implemented with the backend
                integration.
              </p>
              <button
                onClick={() => setSelectedModule(null)}
